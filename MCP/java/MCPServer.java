...
// Import Get_RecipientsMCPTool - included in same package
// Import Get_UsersMCPTool - included in same package
// Import Get_Account_NameMCPTool - included in same package
// Import Put_Account_NameMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            Get_RecipientsMCPTool.createGet_RecipientsTool(config),
            Get_UsersMCPTool.createGet_UsersTool(config),
            Get_Account_NameMCPTool.createGet_Account_NameTool(config),
            Put_Account_NameMCPTool.createPut_Account_NameTool(config)
            );
